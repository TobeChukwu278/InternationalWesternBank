      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-iwb-slate">
            {flatUsers.length} user{flatUsers.length !== 1 ? "s" : ""} registered
          </p>
        </div>
        <div className="flex items-center gap-2 rounded-iwb-lg bg-iwb-teal/10 px-4 py-2">
          ...
          <span className="text-xs text-iwb-slate">Total</span>
        </div>
      </div>
        ...
        <div className="divide-y divide-iwb-border-light">
          ...
          {flatUsers.length === 0 && (
            <div className="flex flex-col items-center gap-3 px-6 py-16">
              ...
              <p className="text-sm font-medium text-iwb-navy">No users yet</p>
              <p className="text-xs text-iwb-slate">Users will appear here once they sign up</p>
            </div>
          )}
        </div>
      </Card>
