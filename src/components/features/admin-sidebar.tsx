...
const navItems = [
  { id: "adminDashboard", href: "/admin/dashboard" },
  { id: "users", href: "/admin/users" },
  { id: "transactions", href: "/admin/transactions" },
  { id: "deposits", href: "/admin/deposits" },
  { id: "transfers", href: "/admin/transfers" },
  { id: "kyc", href: "/admin/kyc" },
  { id: "activity", href: "/admin/activity" },
